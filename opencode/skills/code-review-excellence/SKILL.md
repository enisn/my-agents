...
✅ Good: "Have you considered Repository pattern? It would
...
4. Understand business requirement
...
1. **Architecture & Design**
   - Does solution fit problem?
   - Are there simpler approaches?
   - Is it consistent with existing patterns?
   - Will it scale?

2. **File Organization**
   - Are new files in right places?
...
✅ "How should this behave if API call fails?"

❌ "This is inefficient."
✅ "I see this loops through all users. Have we considered
    performance impact with 100k users?"
```
...
3. **Consider Alternatives**
   ...
   - "What's tradeoff vs. simpler approach?"
...
Example:
"I noticed payment processing logic is inline in the
